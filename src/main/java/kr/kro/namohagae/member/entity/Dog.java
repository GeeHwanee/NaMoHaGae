...
public class Dog {
    ...
    public DogDto.Read toReadDto(String dogNotGenderEnabled) {
        ...
        return new DogDto.Read(dogNo,ImageConstants.IMAGE_DOG_URL +dogProfile,dogName,dogGender,dogCategory,dogBirthdayDate,dogNotGenderEnabled,dogWeight,dogIntroduce);
    }
}
