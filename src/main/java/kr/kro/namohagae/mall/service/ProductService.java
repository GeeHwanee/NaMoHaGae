...
public class ProductService {
    ...
    public Boolean productRecommend(Integer productNo) {
        productDao.updateProductRecommendEnabled(productNo);
        return productDao.findProductRecommendEnabledByProductNo(productNo);
    }
}