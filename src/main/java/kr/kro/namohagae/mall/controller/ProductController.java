...
public class ProductController {
    ...
    public String list(Integer pageNo, Integer categoryNo, Integer memberNo, Model model, HttpSession session) {
        ...
        model.addAttribute("list", service.list(pageNo, categoryNo, memberNo));
